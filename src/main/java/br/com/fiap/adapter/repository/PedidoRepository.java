...
import br.com.fiap.core.domain.model.PedidoCategoria;
...
public class PedidoRepository implements
    ...
    public PedidoResponse update(PedidoUpdateRequest pedidoUpdateRequest) {
        try {
            ...
            pedidoJpa.setCategoria(pedidoUpdateRequest.categoria());
    ...
    @Override
    public List<PedidoResponse> loadByCategoria(PedidoCategoria categoria) {
        return pedidoJpaRepository.findByCategoria(categoria)
                .stream()
